<template>
	<el-dialog class="callout_link" :title="editDial.artTitle" :visible.sync="editDial.setlink" width="40%">
		<div class="link_con">
			...
			<el-form v-show="form.newLinkTypeSwitch==1" ref="form0" :model="form" label-width="120px">
				<el-form-item label="一级导航：">
					<el-select v-model="form0.firtTitle" @change="changFistType" placeholder="请选择链接">
						<el-option v-for="rut in navItem" :key="rut.url" :label="rut.column_name" :value="rut.id">
						</el-option>
					</el-select>
				</el-form-item>
				<el-form-item label="二级导航：">
					<el-select v-model="form0.secTitle" @change="changSecType" placeholder="请选择栏目">
						<el-option v-for="(sec,index) in secondNav" :key="index" :label="sec.column_name" :value="sec.id"></el-option>
					</el-select>
				</el-form-item>
				...
				<el-form-item label="打开方式：">
					<el-checkbox-group v-model="form0.openByNewPage">
			...
			<el-form v-show="form.newLinkTypeSwitch==3" ref="form" :model="form2" label-width="120px">
				...
				<el-form-item label="打开方式：">
					<el-checkbox-group v-model="form2.openByNewPage">
						<el-checkbox label="在新页面打开" name="type"></el-checkbox>
					</el-checkbox-group>
				</el-form-item>
			</el-form>
