		...
		<div class="thrid" v-show="thrid_show">
			...
			<div class="serBorder">
				...
				<p>
					...
					<el-color-picker show-alpha color-format="rgb" size="medium" v-model="itemMdata.titleStyle.color"></el-color-picker>
				</p>
				<p @click="bold" class="radio">
					<span>加粗：</span>
					<input type="checkbox" />
				</p>
			</div>
			<div class="serBorder">
				...
				<p>
					<label for="colorT">字体颜色：</label>
					<el-color-picker show-alpha color-format="rgb" size="medium" v-model="itemMdata.spanStyle.color"></el-color-picker>
				</p>
				<p @click="bold" class="radio">
					<span>加粗：</span>
					<input type="checkbox" />
			...
			<div class="serBorder">
				...
				<div class="serBorder">
					...
					<p>
						<label for="colorT">字体颜色：</label>
						<el-color-picker show-alpha color-format="rgb" size="medium" v-model="itemMdata.inputStyle.color"></el-color-picker>
					</p>
					<div class="setBg">
						<span>输入框背景颜色:</span>
						<el-color-picker show-alpha color-format="rgb" size="medium" v-model="itemMdata.inputStyle.backgroundColor"></el-color-picker>
					</div>
					<div class="setBorder">
						<div class="in">
							<span>上边框：</span>
							...
							<p>
								<label>颜色：</label>
								<el-color-picker show-alpha size="medium" color-format="rgb" v-model="itemMdata.inputStyle.borderTopColor"></el-color-picker>
							</p>
						</div>
						<div class="in">
							<span>下边框：</span>
							...
							<p>
								<label>颜色</label>
								<el-color-picker show-alpha color-format="rgb" size="medium" v-model="itemMdata.inputStyle.borderBottomColor"></el-color-picker>
							</p>
						</div>
						<div class="in">
							<span>左边框：</span>
							...
							<p><label>颜色：</label>
								<el-color-picker show-alpha size="medium" color-format="rgb" v-model="itemMdata.inputStyle.borderLeftColor"></el-color-picker>
							</p>
						</div>
						<div class="in">
							<span>右边框：</span>
							...
							<p><label>颜色：</label>
								<el-color-picker show-alpha size="medium" color-format="rgb" v-model="itemMdata.inputStyle.borderRightColor"></el-color-picker>
							</p>
						</div>
					</div>
				</div>
	...
	export default {
		...
		methods: {
			...
			changeup: function(index) {
				this.itemMdata.siteFormTable.splice(index - 1, 0, (this.itemMdata.siteFormTable[index]));
				this.itemMdata.siteFormTable.splice(index + 1, 1);
			},
			changedown: function(index) {
				this.itemMdata.siteFormTable.splice(index + 2, 0, (this.itemMdata.siteFormTable[index]));
				this.itemMdata.siteFormTable.splice(index, 1);
				if(index == this.itemMdata.siteFormTable.length - 1) {
					alert("已经是最后一项啦！");
				}
			},
			//			arrangeone: function() {
			...
			//			},
			showone: function() {
				this.itemMdata.spanStyle.float = 'none';
				...
				this.itemMdata.inputStyle.width = '100%';
			},
			showtwo: function() {
				this.itemMdata.spanStyle.float = 'left';
				this.itemMdata.spanStyle.width = '23%';
				this.itemMdata.spanStyle.textAlign = 'right';
				this.itemMdata.inputStyle.float = 'left';
				this.itemMdata.inputStyle.width = '77%';
				this.itemMdata.pStyle.marginBottom = '10px';
			}
		},
		computed: {
			...mapGetters(["state"])
