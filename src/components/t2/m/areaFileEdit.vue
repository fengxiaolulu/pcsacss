		...
		<div class="one" v-if="typenumber == 1">
			...
			<div class="size">
				...
				<p @click="itemMdata.size = true">
					<input type="radio" name="size" id="size1" :checked="itemMdata.size == true" />
					<label for="size1">是</label>
				</p>
				<p @click="itemMdata.size = false">
					<input type="radio" name="size" id="size2" :checked="itemMdata.size == false" />
	...
	export default {
		...
		methods: {
			...
			pagehid1: function() {
				...
				//this.itemMdata.page_hid2 = false;
				this.itemMdata.page = true;
			},
			pagehid2: function() {
				this.itemMdata.page_hid1 = false;
				//this.itemMdata.page_hid2 = true;
