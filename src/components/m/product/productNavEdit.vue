	...
	<div class="productNavEdit">
		...
		<div class="one" v-if="typenumber == 1">
			<div class="name">
				...
				<div class="margin clearfloat">
					...
					<p @click="itemMdata.margin_hid = false" class="fl">
						...
						<label for="default">使用产品分类</label>
					</p>
			...
			<div class="managerType" v-if="itemMdata.margin_hid == false">
				<p class="clearfloat"><span class="fl">产品分类名称</span></p>
				<ul class="mType">
			...
			<div class="freeType" v-if="itemMdata.margin_hid == true">
				<p class="clearfloat"><span class="fl">产品分类名称</span><span class="fl">链入产品</span><span class="fr txtR">操作</span></p>
				<ul class="mTypeTwo">
		...
		<el-dialog title="产品分类管理" :modal=false :visible.sync="addVisibleNav" width="60%">
...
<script>
	...
	import productNavDialog from './productNavDialog.vue' //编辑栏目导航
	export default {
		name: 'productNavEdit',
		props: ['itemMdata'],
		data() {
